...
/***/ "./src/components/layout-main/btn-menu/btn-menu.js":
/*!*********************************************************!*\
  !*** ./src/components/layout-main/btn-menu/btn-menu.js ***!
  \*********************************************************/
/***/ (() => {
...
var btnMenu = /*#__PURE__*/function () {
  function btnMenu(elem) {
    _classCallCheck(this, btnMenu);

    this.block = elem;
    this.btnMenu = this.block.querySelector('.btn-menu');
    this.menu = this.block.querySelector('.menu');
    this.btnClose = this.block.querySelector('.btn-close');
    this.bgMobileMenu = document.querySelector('.bg-mobile-menu');
    this.body = document.querySelector('body');
  }

  _createClass(btnMenu, [{
    key: "init",
    value: function init() {
      this.openMenu();
      this.closeMenu();
    ...
    value: function openMenu() {
      ...
      this.btnMenu.addEventListener('click', function (e) {
        _this.menu.classList.add('menu_js-active');

        _this.bgMobileMenu.classList.add('bg-mobile-menu_js-active');

        _this.btnClose.classList.add('btn-close_js-active');

        _this.body.style.overflow = 'hidden';

        _this.block.classList.add('js-active');

        _this.bgMobileMenu.insertAdjacentElement('afterbegin', _this.menu);
      });
    }
  }, {
    key: "closeMenu",
    value: function closeMenu() {
      ...
      this.btnClose.addEventListener('click', function () {
        _this2.menu.classList.remove('menu_js-active');

        _this2.bgMobileMenu.classList.remove('bg-mobile-menu_js-active');

        _this2.btnClose.classList.remove('btn-close_js-active');

        _this2.body.style.overflow = '';

        _this2.block.classList.remove('js-active');
      });
    }
  }]);
...
if (container) {
  new btnMenu(container).init();
}

/***/ }),

/***/ "./src/components/layout-main/main-form/main-form.js":
/*!***********************************************************!*\
  !*** ./src/components/layout-main/main-form/main-form.js ***!
  \***********************************************************/
...
var mainForm = /*#__PURE__*/function () {
  function mainForm(elem) {
    _classCallCheck(this, mainForm);

    this.block = elem;
    this.presonalForm = document.querySelector('.main-form_personal-form');
  }

  _createClass(mainForm, [{
    key: "inputMask",
    value: function inputMask() {
      var inputMask = this.block.querySelector('[data-phone]');
      ...
      inputMask.addEventListener("input", function () {
        var value = inputMask.value.replace(/\D+/g, "");
        var numberLength = 11;
        var result;

        if (inputMask.value.includes("+8") || inputMask.value[0] === "8") {
          result = "";
        } else {
          result = "+";
        }
        ...
        inputMask.value = result;
      });
    }
  }, {
    key: "init",
    value: function init() {
      var selectForm = this.block.querySelector(".form__select-leadership");

      if (selectForm) {
        new (choices_js__WEBPACK_IMPORTED_MODULE_0___default())(selectForm, {
          searchEnabled: false,
          itemSelectText: '',
          classNames: {
            containerInner: 'form__select-leadership'
          }
        });
      }
...
if (document.querySelector('.main-form')) {
  new mainForm(document.querySelector('.main-form')).init();
}

/***/ }),

/***/ "./src/components/layout-main/modal-window/modal-window.js":
/*!*****************************************************************!*\
  !*** ./src/components/layout-main/modal-window/modal-window.js ***!
  \*****************************************************************/
/***/ (() => {
...
var modalWindow = /*#__PURE__*/function () {
  function modalWindow(elem) {
    ...
    this.block = elem;
    this.modalContent = this.block.querySelector('.modal-window__content');
    this.nodeBody = document.querySelector('body');
    this.dataModals = document.querySelectorAll('[data-modal-window]');
    this.btnClose = this.block.querySelector('.modal-window__btn-close');
  }
  ...
  _createClass(modalWindow, [{
    ...
    key: "readDataModals",
    value: function readDataModals() {
      var _this = this;

      this.dataModals.forEach(function (modal) {
        modal.addEventListener('click', function (e) {
          e.preventDefault();
          var idModal = modal.getAttribute('data-modal-window');

          var _modalWindow = document.getElementById(idModal);

          _modalWindow.classList.add('js-open-modal');

          _this.nodeBody.classList.add('js-overflow-hidden');
        });
      });
    }
  }, {
    ...
    value: function closeModal() {
      ...
      this.block.addEventListener('click', function (event) {
        if (!_this2.modalContent.contains(event.target)) {
          _this2.block.classList.remove('js-open-modal');

          _this2.nodeBody.classList.remove('js-overflow-hidden');
        }
      });
      this.btnClose.addEventListener('click', function () {
        _this2.block.classList.remove('js-open-modal');
...
if (elements.length) {
  Array.from(elements).map(function (el) {
    return new modalWindow(el).init();
  });
}

/***/ }),

/***/ "./src/components/layout-main/swiper/swiper.js":
/*!*****************************************************!*\
  !*** ./src/components/layout-main/swiper/swiper.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.swiper')) {
  ...
  sliders.forEach(function (slider) {
    var swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]("#".concat(slider.id), {
      pagination: {
...
/***/ "./src/components/layout-main/tabs/tabs.js":
/*!*************************************************!*\
  !*** ./src/components/layout-main/tabs/tabs.js ***!
  \*************************************************/
/***/ (() => {
...
var Tabs = /*#__PURE__*/function () {
  function Tabs(elem) {
    ...
    this.tabs = elem;
    this.tabItems = document.querySelectorAll('.tabs__item');
    this.tabContentItems = document.querySelectorAll('.tabs-content__item');
  }
  ...
  _createClass(Tabs, [{
      ...
      if (this.tabItems.length) {
        this.tabItems.forEach(function (tab) {
          tab.addEventListener("click", function () {
            _this.tabItems.forEach(function (item) {
              return item.classList.remove('active-tab');
            });

            tab.classList.add('active-tab');

            _this.activeTabContent(tab.id);
          });
        });
      }
    }
    ...
    value: function activeTabContent(id) {
      this.tabContentItems.forEach(function (content) {
...
/***/ "./src/pages/layout-main/index/location/map.js":
/*!*****************************************************!*\
  !*** ./src/pages/layout-main/index/location/map.js ***!
  \*****************************************************/
/***/ (() => {
...
function init() {
  var locationMap = new ymaps.Map("locationMap", {
    center: [55.189881, 83.142107],
    zoom: 16,
    controls: ['fullscreenControl'],
    behaviors: ['drag', 'dblClickZoom', 'multiTouch']
  });
  var placemark = new ymaps.Placemark([55.189881, 83.142107], {
    hintContent: 'Новосибирская обл., п. Октябрьский, ул. Локтинская, д. 10/2',
    balloonContent: 'Новосибирская обл., п. Октябрьский, ул. Локтинская, д. 10/2',
    iconCaption: 'Локтинская улица, 14'
  });
...
/* harmony import */ var _components_layout_main_swiper_swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/layout-main/swiper/swiper */ "./src/components/layout-main/swiper/swiper.js");
/* harmony import */ var _components_layout_main_modal_window_modal_window__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/layout-main/modal-window/modal-window */ "./src/components/layout-main/modal-window/modal-window.js");
/* harmony import */ var _components_layout_main_modal_window_modal_window__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_layout_main_modal_window_modal_window__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_layout_main_btn_menu_btn_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/layout-main/btn-menu/btn-menu */ "./src/components/layout-main/btn-menu/btn-menu.js");
/* harmony import */ var _components_layout_main_btn_menu_btn_menu__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_layout_main_btn_menu_btn_menu__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _components_layout_main_main_form_main_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/layout-main/main-form/main-form */ "./src/components/layout-main/main-form/main-form.js");
/* harmony import */ var _components_layout_main_tabs_tabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/layout-main/tabs/tabs */ "./src/components/layout-main/tabs/tabs.js");
/* harmony import */ var _components_layout_main_tabs_tabs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_layout_main_tabs_tabs__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _pages_layout_main_index_location_map__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/layout-main/index/location/map */ "./src/pages/layout-main/index/location/map.js");
/* harmony import */ var _pages_layout_main_index_location_map__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_pages_layout_main_index_location_map__WEBPACK_IMPORTED_MODULE_6__);
// -----> СТИЛИ ПРОЕКТА
 // -----> JAVASCRIPT ПРОЕКТА
// ---> Подключение JS плагинов
// подключение слайдера

 // ---> Индивидуальные JS скрипты
// Модальное окно
